...
public class InputTicketBLL {
    ...
    public String insertInputTicket(Integer id, String timeCreate, Integer employeeId, String supplierId, Long totalPrice, Integer status) {
        if (id == null || timeCreate == null || employeeId == null || supplierId == null || totalPrice == null || status == null) {
            return "Thông tin phiếu nhập không đầy đủ";
        }

        InputTicketDTO dto = new InputTicketDTO(id, timeCreate, employeeId, supplierId, totalPrice, status);
        int result = inputTicketDAL.insert(dto);
        return result > 0 ? "Thêm phiếu nhập thành công" : "Thêm phiếu nhập thất bại";
    }

    public String updateInputTicket(Integer id, String timeCreate, Integer employeeId, String supplierId, Long totalPrice, Integer status) {
        if (id == null || timeCreate == null || supplierId == null || totalPrice == null || status == null || employeeId == null) {
            return "Thông tin phiếu nhập không đầy đủ";
        }
