...
public class SupplierBLL {
    ...
    // Thêm nhà cung cấp
    public String insertSupplier(String id, String name, String phone, String email, String address, String status,
            String timeUpdate) {
        // Kiểm tra đầu vào
        if (!isInputed(id))
            return "Chưa nhập mã nhà cung cấp";
        if (!isInputed(name))
        ...
        // Kiểm tra định dạng
        if (!isValidId(id))
            return "Mã nhà cung cấp phải có định dạng NCCxx (x là số)";
        ...
        SupplierDTO newSupplier = new SupplierDTO(id, name, phone, email, address, supplierStatus, timeUpdate);
    ...
    public String updateSupplier(String id, String name, String phone, String email, String address,
            String timeUpdate) {
        // Kiểm tra đầu vào
        if (!isInputed(name))
            return "Chưa nhập tên nhà cung cấp";
        ...
        SupplierDTO updatedSupplier = new SupplierDTO(id, name, phone, email, address, null, timeUpdate);
    ...
    public String lockSupplier(String id, String timeUpdate) {
        ...
        supplier.setTimeUpdate(timeUpdate);
    ...
    public SupplierDTO getOneSupplierById(String supplierId) {
        return supplierDAL.selectOneById(supplierId);
    }
