...
public class IngredientBLL {
    ...
    public String insertIngredient(String id, String name, String unit, String inventory, boolean status, String dateUpdate) {
    ...
    public String updateIngredient(String id, String name, String unit, String inventory, boolean status, String dateUpdate) {
    ...
    public IngredientDTO getLastIngredient() {
        ArrayList<IngredientDTO> ingredients = getAllIngredientsByCondition(null, null, "id DESC");
